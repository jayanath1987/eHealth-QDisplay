		  ...
		  <div class="container-fluid">
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			  <ul class="nav navbar-nav">
				<li class=""><a href="#"><b><i><img src="../../images/digital_health.png" alt="Digital Health" height="62" width="125"></i></b> <b><i><img src="../../images/icta.png" alt="ICTA" height="62" width="202"></i></b></a></li>
			  </ul>
...
QDisplay.set_ajax_url("<?php echo site_url("qdisplay/get_laboratory_queue"); ?>");
...
QDisplay.load_audio_files(
		function(){
			QDisplay.run_laboratory_display();
		}
	);
